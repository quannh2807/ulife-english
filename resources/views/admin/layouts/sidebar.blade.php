<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('images/default_user.png') }}" alt="" class="brand-image img-circle elevation-3"
             style="opacity: .8;">
        <span class="brand-text font-weight-bold">{{ Auth::user()->acc_name }}</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
