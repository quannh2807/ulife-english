                        ...
                        <div class="col-6">
                            ...
                            <div class="col form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="lesson-thumb" name="thumb_img"
                                           value="{{ $lesson->thumb_img }}" onchange="encodeImageFileAsURL(this)">
                                    <label class="custom-file-label" for="lesson-thumb">Chọn ảnh</label>
                                </div>
