                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <select name="course_id" id="lesson-course"
                                                ...
                                                <option value="{{ $item->id }}" {{ $lesson->course_id == $item->id ?
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="level_id" id="lesson-level"
                                                ...
                                                <option value="{{ $level->id }}" {{ $lesson->level_id == $level->id ?
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="status" id="lesson-status"
                                                ...
                                                <option value="{{ $value }}" {{ $lesson->status == $value ? 'selected' :
                                                    '' }}>{{ $key }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="grpThumb" class="form-group">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioUpload"
                                                    data-path="{{$lesson->thumb_img}}" id="inlineRadio1" value="1"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioUpload"
                                                    data-path="{{$lesson->thumb_img}}" id="inlineRadio2" value="2"
                                                    @if(isUrl($lesson->thumb_img)) checked @else @endif>
                                        ...
                                        <div class="boxThumb">
                                            ...
                                            <input id="thumbLink" name="thumb" type="text"
                                                class="form-control input-file-dummy" value="{{$lesson->thumb_img}}"
                                                placeholder="Nhập vào link ảnh">
                                            @else
                                            <div class="input-group">
                                                <input type="text" class="form-control input-file-dummy" readonly
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="itemBorder">
                                            ...
                                            <div id="chooseVideoGrammarList">
                                                <input style="display: none;" type=" text" class="videoGrammarIds"
                                                    name="videoGrammarIds" value="{{$grammarIds}}">
                                                <ul>
                                                    @if(!empty($grammarVideoData))
                                                    @foreach($grammarVideoData as $index => $item)
                                                    <li id="{{$item->id}}">
                                                        <div class="alert  alert-info alert-dismissible" role="alert">
                                                            <button id="removeVideoGrammar" data-id="{{$item->id}}"
                                                                type="button" class="close" data-dismiss="alert"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">×</span></button>
                                                            <span id="grammarVideoId"
                                                                style="display:none;">{{$item->id}}</span>
                                                            <img style="margin-right: 10px;" width="50" height="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="itemBorder">
                                            ...
                                            <div id="chooseVideoLessonList">
                                                <input style="display: none;" type=" text" class="videoLessonIds"
                                                    name="videoLessonIds" value="{{$lessonIds}}">
                                                <ul>
                                                    @if(!empty($lessonVideoData))
                                                    @foreach($lessonVideoData as $index => $item)
                                                    <li id="{{$item->id}}">
                                                        <div class="alert  alert-info alert-dismissible" role="alert">
                                                            <button id="removeVideoLesson" data-id="{{$item->id}}"
                                                                type="button" class="close" data-dismiss="alert"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">×</span></button>
                        ...
                        <div class="card-body" style="max-height: 400px; overflow-x: scroll">
                            <div class="input_fields_speak">
                                ...
                                <div class="row" id="itemDynamic" data-position="{{$index}}">
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <input name="id_speak[{{$index}}]" type="text" value="{{$item->id}}" hidden>
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text"
                                                        ...
                                                        aria-describedby="fileHelp" value="{{ $item->en }}">
                                                    <label class="input-group-append mb-0">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="form-control form-control-sm input-file-dummy"
                                                        name="speak_name_vi[{{$index}}]" value="{{ $item->vi }}"
                        ...
                        <div class="card-body" style="max-height: 400px; overflow-x: scroll">
                            <div class="input_fields_write">
                                ...
                                <div class="row" id="itemDynamic" data-position="{{$index}}">
                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <input name="id_write[{{$index}}]" type="text" value="{{$item->id}}" hidden>
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="form-control form-control-sm input-file-dummy"
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text"
                                                        ...
                                                        placeholder="Nhập vào nội dung tiếng việt"
                                                        aria-describedby="fileHelp" value="{{ $item->vi }}">
                                                    <label class="input-group-append mb-0">
                                                        <span class="btn btn-sm btn-success input-file-btn">
                                                            <i class="fas fa-file-audio"></i>&nbsp;&nbsp;Chọn file
                            ...
                            <div class="input_fields_exercises">
                                ...
                                <div class="layoutBorder" id="itemDynamic" data-position="{{$index}}">
                                    <div class="row">
                                        ...
                                        <div class="content">
                                            <div class="row">
                                                <input name="id_exercises[{{$index}}]" type="text" value="{{$item->id}}"
                                                    hidden>
                                                <div class="col-sm-10">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-sm"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="act-out-name-one"><span
                                                ...
                                                thứ nhất<span class="text-danger">*</span></label>
                                        ...
                                        <div id="characterOne" class="form-group">
                                            ...
                                            <div id="grpAvatarThumb" class="form-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        id="avatarOneUpload" value="1" @if(!empty($actOutCharacter) &&
                                                        count($actOutCharacter)>= 1 &&
                                                    !isUrl($actOutCharacter[0]->image)) checked @else @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineCharacterOne"
                                                        data-path-avatar-1="{{!empty($actOutCharacter) && count($actOutCharacter) >= 1 ? $actOutCharacter[0]->image :''}}"
                                                        id="avatarOneLink" value="2" @if(!empty($actOutCharacter) &&
                                                        count($actOutCharacter)>= 1 &&
                                                    isUrl($actOutCharacter[0]->image)) checked @else @endif>
                                            ...
                                            <div class="boxThumbCharacterOne">
                                                @if(!empty($actOutCharacter) && count($actOutCharacter) >= 1 &&
                                                isUrl($actOutCharacter[0]->image))
                                                <input id="characterOneUpload" name="characterOneUpload" type="text"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="characterTwo" class="form-group">
                                            ...
                                            <div id="grpAvatarTwo" class="form-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        id="avatarTwoUpload" value="1" @if(!empty($actOutCharacter) &&
                                                        count($actOutCharacter)>= 2 &&
                                                    !isUrl($actOutCharacter[1]->image)) checked @else @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineCharacterTwo"
                                                        data-path-avatar-2="{{!empty($actOutCharacter) && count($actOutCharacter) >= 2 ? $actOutCharacter[1]->image : ''}}"
                                                        id="avatarTwoLink" value="2" @if(!empty($actOutCharacter) &&
                                                        count($actOutCharacter)>= 2 &&
                                                    isUrl($actOutCharacter[1]->image)) checked @else @endif>
                                            ...
                                            <div class="boxThumbCharacterTwo">
                                                @if(!empty($actOutCharacter) && count($actOutCharacter) >= 2 &&
                                                isUrl($actOutCharacter[1]->image))
                                                <input id="characterTwoUpload" name="characterTwoUpload" type="text"
                                                    class="form-control input-file-dummy"
                                        ...
                                        <tr style="cursor: pointer">
                                            ...
                                            <td>
                                                <input hidden name="actOutId[{{$index}}]"
                                                    class="form-control form-control-sm" value="{{$item->id}}">
                                                <div class="form-group">
                                                    <div class="form-check form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="actOutCharacterId[{{$index}}]"
                                                            id="character1_{{$index}}" value="1" {{ ($item->characterId
                                                        == 1) ? 'checked': '' }}>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="actOutCharacterId[{{$index}}]"
                                                            id="character2_{{$index}}" value="2" {{ ($item->characterId
                                                        == 2) ? 'checked': '' }}>
                                            ...
                                            <td>
                                                <div>
                                                    <span class="item-child-lbl"><i class="fa fa-clock"></i>&nbsp;Time
                                                        start:&nbsp;</span>
                                                    <span class="item-child-val">{{ seconds2SRT($item->time_start)
                                                        }}</span>
                                                ...
                                                <div>
                                                    ...
                                                    <span class="item-child-val">{{ seconds2SRT($item->time_end)
                                                        }}</span>
                                            ...
                                            <td>
                                                <input name="actOutEn[{{$index}}]" class="form-control form-control-sm"
                                                    value="{{$item->en}}">
                                            </td>
                                            <td>
                                                <input name="actOutVi[{{$index}}]" class="form-control form-control-sm"
                                                    value="{{$item->vi}}">
                                            </td>
                                        </tr>
                                        @endforeach
            ...
            <div class="row" style="padding-bottom: 20px;">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-end">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;&nbsp;Cập nhật
                        </button>
                    </div>
                </div>
            </div>
